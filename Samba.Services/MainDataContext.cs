...
namespace Samba.Services
{
    ...
    public class MainDataContext
    {
        ...
        private static TimeCardEntry.TimeCardActionEnum _timeCardAction = TimeCardEntry.TimeCardActionEnum.None;

        public static TimeCardEntry.TimeCardActionEnum TimeCardAction { 
